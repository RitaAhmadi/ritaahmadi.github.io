...
<section class="section-block">
  ...
  <div class="essay-list">
    ...
    <!-- Copy an .essay-item to add more -->
    <a class="essay-item" href="https://aeon.co/essays/how-should-we-define-mathematical-beauty-in-the-ai-age" target="_blank">
      <div class="essay-meta">
        <div class="essay-venue">Aeon · 2026</div>
        <div class="essay-title">How Should We Define Mathematical Beauty in the AI Age?</div>
      </div>
...
<section class="section-block">
  ...
  <div class="service-list">
    ...
    <!-- Copy a .service-item to add more -->
...
<style>
  ...
  .essay-item:last-child { border-bottom: 1px solid var(--light); }
  .essay-item:hover { opacity: 0.5; }
